 ...
 */
 public final class StdIn {
     ...
     // assume language is English, country is US for consistency with
     // System.out.
     private static final java.util.Locale usLocale = 
         new java.util.Locale("en", "US");

     // the default token separator; we maintain the invariant that 
     // this value is held by the scanner's delimiter between calls
     ...
     /**
      * Does the input have a next line? Use this to know whether the next 
      * call to {@link #readLine()} will succeed. <p> Functionally 
      * equaivalent to {@link #hasNextChar()}.
      */
     ...
     public static String readAll() {
         ...
         // not that important to reset delimiter, since now scanner is 
         // empty
         scanner.useDelimiter(WHITESPACE_PATTERN);
         return result;
     }
   ...
   /**
    ...
    public static String[] readAllStrings() {
        ...
        // not consistent since trim() uses characters 0x00..0x20 as
        // whitespace
